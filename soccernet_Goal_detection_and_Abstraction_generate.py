                            ...
                            for game_root, _, videos in os.walk(game_path):
                                for video_index in videos:
                                    ...
                                    for annotation in labels["annotations"]:
                                        if annotation["label"] == "Goal" and annotation["gameTime"][0] == video_index[0]:
                                    ...
                                    logging.info("视频属性：   总帧数：{}   FPS:{}   width:{}   height:{}".format(frame_count, fps,
                                                                                                  frame_width,
                                                                                                  frame_height))
                                    ...
                                    logging.info("##################### video:{}  goal events ####################".format(
                                        video_name))
                                    ...
                                    for key in time_line_sorted:
                                        ...
                                        if goal_type == 'N':
                                            if team == left_team:
                                                ...
                                                video_text = name + " from " + team + " shot a goal!" + " At " + key[
                                                    0] + '\''
                                            else:
                                    ...
                                    logging.info("GT : {}， 共找到：{}， 其中正确的：{}".format(len(gt_goal_frame_indexes), len(time_line), len(get_right_goal_frame_indexes)))
                                    logging.info("####################################################")
